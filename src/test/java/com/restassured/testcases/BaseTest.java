...
public class BaseTest {
	...
	protected void performOAuth() {
		...
		Response response = given().header("Content-Type", "application/json")
				...
				.formParam("username", Constants.USERNAME).formParam("grant_type", Constants.GRANT_TYPE)
				.formParam("client_id", Constants.CLIENT_ID).formParam("password", Constants.PASSWORD)
